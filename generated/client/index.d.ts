...
export namespace Prisma {
  ...
  */
  ...
  export type JokeGetPayload<S extends boolean | null | undefined | JokeArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Joke :
    S extends undefined ? never :
    S extends { include: any } & (JokeArgs | JokeFindManyArgs)
    ? Joke 
    : S extends { select: any } & (JokeArgs | JokeFindManyArgs)
      ? {
  ...
  export interface JokeDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Joke'> extends True ? Prisma__JokeClient<JokeGetPayload<T>> : Prisma__JokeClient<JokeGetPayload<T> | null, null>
     ...
     * })
    **/
    findUniqueOrThrow<T extends JokeFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, JokeFindUniqueOrThrowArgs>
    ): Prisma__JokeClient<JokeGetPayload<T>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Joke'> extends True ? Prisma__JokeClient<JokeGetPayload<T>> : Prisma__JokeClient<JokeGetPayload<T> | null, null>
     ...
     * })
    **/
    findFirstOrThrow<T extends JokeFindFirstOrThrowArgs>(
      args?: SelectSubset<T, JokeFindFirstOrThrowArgs>
    ): Prisma__JokeClient<JokeGetPayload<T>>
    ...
    **/
    ...
    ): PrismaPromise<Array<JokeGetPayload<T>>>
   ...
   */
  export class Prisma__JokeClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
  ...
  /**
   * Joke base type for findUnique actions
   */
  export type JokeFindUniqueArgsBase = {
    /**
   ...
   * Joke: findUnique
   */
  export interface JokeFindUniqueArgs extends JokeFindUniqueArgsBase {
   /**
   ...
   */
  export type JokeFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Joke
     * 
    **/
  ...
  /**
   * Joke base type for findFirst actions
   */
  export type JokeFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Joke
     * 
    **/
   ...
   * Joke: findFirst
   */
  export interface JokeFindFirstArgs extends JokeFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
   ...
   */
  export type JokeFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Joke
     * 
    **/
